...
const UpdateLibraryItemForm = ({ libraryItem, onClose }) => {
  ...
  const [tags, setTags] = useState(libraryItem.tag_list);
  const videoRef = useRef();

  const { mutate: updateLibraryItem, isSuccess: updateLibraryItemIsSuccess } =
  ...
  const addLibraryItemHandler = (event) => {
    ...
    updateLibraryItem({ id: libraryItem.id, library_item: formData });
  };
        ...
        <div className={classes.controlGroup}>
          ...
          <div className={classes.formControl}>
            ...
            <input
              ...
              ref={videoRef}
            />
            <Button size="small" onClick={() => videoRef.current.click()}>
              Add Video
            </Button>
          </div>
          <div className={classes.formActions}>
            ...
            <Button
              size="small"
              type="submit"
              disabled={titleHasError || isMutating}
            >
