  ...
  return (
    <Modal onClose={onClose}>
      <div className={classes.textContainer}>
        <h2 className={classes.warning}>Warning: deleting a library item may mean a program will not function correctly. Make sure this item isn't being used in any programs</h2>
